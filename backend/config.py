...
NOTE_STYLE_AUTOSEND = env_bool("NOTE_STYLE_AUTOSEND", False)
NOTE_STYLE_STAGE_AUTORUN = env_bool("NOTE_STYLE_STAGE_AUTORUN", False)
...
NOTE_STYLE_JSON_ONLY_ENFORCE = env_bool("NOTE_STYLE_JSON_ONLY_ENFORCE", True)
