...
MERGE_PACKS_DIR = env_str("MERGE_PACKS_DIR", "ai_packs/merge/packs")
MERGE_RESULTS_DIR = env_str("MERGE_RESULTS_DIR", "ai_packs/merge/results")
MERGE_PACK_GLOB = env_str("MERGE_PACK_GLOB", "pair_*.jsonl")
MERGE_INDEX_PATH = env_str("MERGE_INDEX_PATH", "ai_packs/merge/index.json")
...
NOTE_STYLE_USE_MANIFEST_PATHS = env_bool(
    "NOTE_STYLE_USE_MANIFEST_PATHS", False
)
