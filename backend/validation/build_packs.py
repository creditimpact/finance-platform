...
_SYSTEM_PROMPT = (
    ...
    "The AI’s role is not to restate what the system found or explain how the mismatch was detected, but to decide whether the differences between bureau statements represent a legally meaningful inconsistency that a consumer dispute could rely on.\n\n"
    "In essence, the AI answers one question:\n"
    "\"Is this discrepancy strong enough that a credit bureau would be obligated or reasonably expected to investigate or correct it if disputed?\"\n\n"
    ...
    "The AI evaluates these values exactly as written, decides the dispute strength, and produces a JSON decision per the expected schema."
)
